...
//    - To test: cargo run --bin mdl-test -- --config ../inputs/mdl1/config.json --mdl ../inputs/mdl1/mdl.cbor --prover_inputs ../generated_files/mdl1/prover_inputs.json --prover_aux ../generated_files/mdl1/prover_aux.json
